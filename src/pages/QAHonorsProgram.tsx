            ...
            <section className="relative pt-32 pb-20 overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    ...
                    >
                        ...
                        <p className="text-xl md:text-2xl text-[#3FC4E2] font-semibold mb-6">
                            Empowering Georgian Youth for Global Tech Careers
                        </p>

                        <div className="flex flex-wrap items-center justify-center gap-4 text-[#3FC4E2] font-semibold mb-10">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Button
                                ...
                                className="bg-transparent border-2 border-[#3B7DBF] text-white hover:bg-[#3B7DBF]/10 font-semibold px-10 py-6 rounded-lg text-lg transition-all duration-300"
                            >
                                Program Overview
                            </Button>
                            <Button
                                onClick={() => setIsModalOpen(true)}
                                className="bg-[#3B7DBF] hover:bg-[#3B7DBF] text-white font-semibold px-10 py-6 rounded-lg text-lg shadow-lg shadow-[#3B7DBF]/25 hover:shadow-[#3B7DBF]/40 transition-all duration-300 hover:scale-105"
                            >
                                Apply for Selection
                            </Button>
                        </div>
                ...
                <div className="container mx-auto px-6">
                    ...
                    >
                        <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center">
                            What is the <span className="text-[#3FC4E2]">QA Honors Program</span>
                        </h2>
                        ...
                        <div className="space-y-6 text-lg text-white/80 leading-relaxed">
                            ...
                            <p className="text-[#3FC4E2] font-semibold">
                ...
                <div className="container mx-auto px-6">
                    ...
                    >
                        <h2 className="text-3xl md:text-4xl font-bold mb-4">
                            How the <span className="text-[#3FC4E2]">Program Works</span>
                        </h2>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
                        ...
                        >
                            <div className="flex items-center gap-3 mb-6">
                                <div className="w-12 h-12 rounded-full bg-[#3B7DBF] flex items-center justify-center">
                                    <Users className="w-6 h-6" />
                                </div>
                                <h3 className="text-2xl font-bold">Admission Process</h3>
                            </div>

                            <p className="text-[#3FC4E2] font-semibold mb-6">
                                3 Stages
                            </p>
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-2 text-white/70">
                                        <li className="flex items-start gap-2">
                                            <CheckCircle className="w-5 h-5 text-[#3FC4E2] flex-shrink-0 mt-0.5" />
                        ...
                        >
                            ...
                            <div className="flex gap-4 mb-6">
                                <span className="text-[#3FC4E2] font-semibold"> Start Date: April 27</span>
                                <span className="text-white/40">|</span>
                                <span className="text-[#3FC4E2] font-semibold">⏱ Duration: 10 weeks</span>
                            </div>
                ...
                <div className="container mx-auto px-6">
                    ...
                    >
                        <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                            Start Your <span className="text-[#3FC4E2]">QA Career</span>
                        </h2>
                        ...
                        <div className="bg-[#1a2332] border border-white/10 rounded-2xl p-8 mb-10">
                            <div className="space-y-2 text-lg">
                                <p className="text-[#3FC4E2] font-bold"> March 20, 2026</p>
                        ...
                        <Button
                            onClick={() => setIsModalOpen(true)}
                            className="bg-[#3B7DBF] hover:bg-[#3B7DBF] text-white font-semibold px-12 py-6 rounded-lg text-lg shadow-lg shadow-[#3B7DBF]/25 hover:shadow-[#3B7DBF]/40 transition-all duration-300 hover:scale-105"
                        >
                            Apply Now
                        </Button>
                    </div>
                ...
                <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={() => setIsModalOpen(false)}>
                    ...
                    >
                        ...
                        <div className="text-white/70 mb-6 space-y-3">
                            ...
                            <p className="text-[#3FC4E2] font-semibold">All fields below are mandatory.</p>
                        </div>
                        {submitSuccess ? (
                            <div className="text-center py-4">
                                <div className="w-12 h-12 rounded-full bg-[#3B7DBF]/20 flex items-center justify-center mx-auto mb-4">
                                    <CheckCircle className="w-6 h-6 text-[#3FC4E2]" />
                                </div>
                            ...
                            <>
                                <div className="space-y-4 mb-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-white/5 border border-white/20 rounded-lg px-4 py-3 text-white placeholder-white/30 focus:outline-none focus:border-[#3B7DBF] transition-colors"
                                        />
                                    </div>
                                    <div>
                                            ...
                                            {['3 – 5 hours', '6 – 8 hours', '9 – 11 hours', '12+ hours'].map((option) => (
                                                <label key={option} className="flex items-center space-x-3 cursor-pointer">
                                                    <input
                                                        ...
                                                        className="w-4 h-4 text-[#3B7DBF] bg-white/5 border-white/20 focus:ring-[#3B7DBF] focus:ring-2"
                                                    />
                                ...
                                <div className="flex flex-col gap-3">
                                    <Button
                                        ...
                                        className="w-full bg-[#3B7DBF] hover:bg-[#3B7DBF] text-white font-semibold py-3 rounded-lg"
                                    >
