...
export default function PurchaseSuccess() {
  ...
  if (isLoading) {
    return (
      <div className="bg-[#0F2E4A] min-h-screen flex items-center justify-center">
        ...
        >
          ...
          <div className="bg-[#1a2332] border border-white/10 rounded-2xl p-8 mb-8 text-left">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <Mail className="w-5 h-5 text-[#3FC4E2] mt-0.5 flex-shrink-0" />
                <div>
              ...
              <div className="flex items-start gap-3">
                <Download className="w-5 h-5 text-[#3FC4E2] mt-0.5 flex-shrink-0" />
                <div>
          ...
          <p className="text-white/40 text-sm mt-12">
            ...
            <a
              ...
              className="text-[#3FC4E2] hover:underline"
            >
              support@genofit.com
            </a>
          </p>
